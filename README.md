...
- **Zone completion**: how much of a zone you've done, Guild Wars 2 style. Areas explored and flight paths learned count for the character; dungeons count the Legacy clears on your account. It shows in the world map's corner, for the zone you're viewing, with a percentage per zone on continent maps. It can also show in the objective tracker, for the zone you're in (the zone name, a percentage and one row of counts), once you tick that in the map menu. Each can be collapsed, and hovering lists what's left. "What counts" in the same menu leaves out any category you don't care about, and the percentage follows.
