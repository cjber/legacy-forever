...
read_globals = {
	"AchievementFrame_SelectAchievement", "AlertFrame", "AlertFrame_OnClick", "C_Map", "C_MapExplorationInfo", "C_QuestLog", "C_Reputation", "C_TaxiMap", "C_Timer", "C_Traits", "CreateAtlasMarkup",
	...
	"ObjectiveTrackerManager", "MapCanvasDataProviderMixin", "MapCanvasPinMixin", "LibQuestieDB", "Questie", "QuestieLoader", "strtrim",
	"tContains", "ToggleLegacySystemUI", "ToggleWorldMap", "OpenWorldMap", "UnitClass", "UnitFactionGroup", "UnitGUID", "UnitRace", "UIParent", "WHITE_FONT_COLOR", "WorldMapFrame",
}
