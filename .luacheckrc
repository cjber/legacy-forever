...
read_globals = {
	...
	"CreateFrame", "CreateFromMixins", "DEFAULT_CHAT_FRAME", "Enum", "EventUtil", "GameTooltip",
	...
	"GetAchievementNumCriteria", "GetBuildInfo", "GetCategoryList", "GetCategoryNumAchievements", "hooksecurefunc",
